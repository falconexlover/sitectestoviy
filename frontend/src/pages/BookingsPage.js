    ...
    return (
      <PageContainer>
        <PageHeader>
          ...
          <PageSubtitle>
            История и детали ваших бронирований
          </PageSubtitle>
        </PageHeader>
      ...
      <BookingList>
        {bookings.map(booking => (
          <BookingCard key={booking._id}>
            <BookingHeader>
              <BookingNumber>
                Бронирование <span>#{booking.bookingNumber || 'БН-' + booking._id.substring(0, 8)}</span>
              </BookingNumber>
            ...
            <BookingBody>
              <BookingInfo>
                ...
                <BookingDetails>
                  ...
                  <DetailItem>
                    ...
                    <span>{Math.ceil((new Date(booking.checkOut) - new Date(booking.checkIn)) / (1000 * 60 * 60 * 24))}</span>
                  </DetailItem>
                  <DetailItem>
              ...
              <BookingFooter>
                <BookingPrice>
                  {booking.totalPrice ? `${booking.totalPrice.toLocaleString()} ₽` : (booking.room ? `${booking.room.price.toLocaleString()} ₽ за ночь` : 'Цена недоступна')}
                </BookingPrice>
